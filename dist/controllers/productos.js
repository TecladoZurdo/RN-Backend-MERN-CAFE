...
const obtenerProductos = (req, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
...
const obtenerProducto = (req, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
const crearProducto = (req, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    const _a = req.body, { estado, usuario } = _a, body = __rest(_a, ["estado", "usuario"]);
    const productoDB = yield producto_1.default.findOne({
    ...
    // Guardar DB
    const nuevoProducto = yield producto.save();
    yield nuevoProducto
        .populate("usuario", "nombre")
        .populate("categoria", "nombre")
        .execPopulate();
...
const actualizarProducto = (req, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
const borrarProducto = (req, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
